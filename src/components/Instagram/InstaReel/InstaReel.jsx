...
<div className='flex  gap-2 items-center'>
        <label
          ...
          >
            {profileImg ? (
              ...
              />
                ...
                <img src={webq} alt=""  style={{ width: "30px", height: "30px", border:'1px solid white', borderRadius:'50%'}} />
          ...
          <h5 className="text-white font-semibold input-hover " contentEditable={true} >Company Name</h5>
                <p className="text-[12px]  text-white font-normal " style={{lineHeight:'10px'}}>Sponsored</p>
          </div>
        </div>
        <div className='flex justify-evenly items-center mt-5 mb-5 w-[90%]'>
        <div className="icons flex justify-evenly w-full ">
        <button className=" button flex items-center justify-between w-full  text-black font-bold m-auto p-2 ps-4 pe-5 rounded-lg bg-white" contentEditable={true}>
         <span className='input-hover'>Download</span> 
         <svg width='13' height='13' data-v-45aa4ba6="" version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 256 256" xml:space="preserve"><g data-v-45aa4ba6=""><g data-v-45aa4ba6=""><polygon data-v-45aa4ba6="" points="79.093,0 48.907,30.187 146.72,128 48.907,225.813 79.093,256 207.093,128 "></polygon></g></g><g data-v-45aa4ba6=""></g><g data-v-45aa4ba6=""></g><g data-v-45aa4ba6=""></g><g data-v-45aa4ba6=""></g><g data-v-45aa4ba6=""></g><g data-v-45aa4ba6=""></g><g data-v-45aa4ba6=""></g><g data-v-45aa4ba6=""></g><g data-v-45aa4ba6=""></g><g data-v-45aa4ba6=""></g><g data-v-45aa4ba6=""></g><g data-v-45aa4ba6=""></g><g data-v-45aa4ba6=""></g><g data-v-45aa4ba6=""></g><g data-v-45aa4ba6=""></g></svg>
        </button>
      </div>
        </div>
        <p className='text-gray-300  mt-3 w-[100%] text-xs' contentEditable={true}><span className='input-hover'>Ad Mockups lets you create fast and easy mockups all in one place. Test it out!</span></p>

        
        </div>
        <div>
        <svg widths={20} className='cursor-pointer mb-4' data-v-45aa4ba6="" aria-label="Like" color="white" fill="white" height="24" role="img" viewBox="0 0 24 24" width="24"><path data-v-45aa4ba6="" d="M16.792 3.904A4.989 4.989 0 0121.5 9.122c0 3.072-2.652 4.959-5.197 7.222-2.512 2.243-3.865 3.469-4.303 3.752-.477-.309-2.143-1.823-4.303-3.752C5.141 14.072 2.5 12.167 2.5 9.122a4.989 4.989 0 014.708-5.218 4.21 4.21 0 013.675 1.941c.84 1.175.98 1.763 1.12 1.763s.278-.588 1.11-1.766a4.17 4.17 0 013.679-1.938m0-2a6.04 6.04 0 00-4.797 2.127 6.052 6.052 0 00-4.787-2.127A6.985 6.985 0 00.5 9.122c0 3.61 2.55 5.827 5.015 7.97.283.246.569.494.853.747l1.027.918a44.998 44.998 0 003.518 3.018 2 2 0 002.174 0 45.263 45.263 0 003.626-3.115l.922-.824c.293-.26.59-.519.885-.774 2.334-2.025 4.98-4.32 4.98-7.94a6.985 6.985 0 00-6.708-7.218z"></path></svg>

        <svg widths={20} className='cursor-pointer mb-4' data-v-45aa4ba6="" aria-label="Comment" color="white" fill="white" height="24" role="img" viewBox="0 0 24 24" width="24"><path data-v-45aa4ba6="" d="M20.656 17.008a9.993 9.993 0 10-3.59 3.615L22 22z" fill="none" stroke="currentColor" stroke-linejoin="round" stroke-width="2"></path></svg>
        <svg widths={20} className='cursor-pointer mb-4' data-v-45aa4ba6="" aria-label="Share Post" color="white" fill="white" height="24" role="img" viewBox="0 0 24 24" width="24"><line data-v-45aa4ba6="" fill="none" stroke="currentColor" stroke-linejoin="round" stroke-width="2" x1="22" x2="9.218" y1="3" y2="10.083"></line><polygon data-v-45aa4ba6="" fill="none" points="11.698 20.334 22 3.001 2 3.001 9.218 10.084 11.698 20.334" stroke="currentColor" stroke-linejoin="round" stroke-width="2"></polygon></svg>

      
        <svg widths={20}  data-v-45aa4ba6="" aria-label="More options" fill="white" height="20" viewBox="0 0 48 48" width="20" class="_8-yf5"><circle data-v-45aa4ba6="" clip-rule="evenodd" cx="8" cy="24" fill-rule="evenodd" r="4.5"></circle><circle data-v-45aa4ba6="" clip-rule="evenodd" cx="24" cy="24" fill-rule="evenodd" r="4.5"></circle><circle data-v-45aa4ba6="" clip-rule="evenodd" cx="40" cy="24" fill-rule="evenodd" r="4.5"></circle></svg>
</div>
        </div>
    </div>
    </div>

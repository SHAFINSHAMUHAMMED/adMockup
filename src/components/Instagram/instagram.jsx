  ...
  return (
    <div className="flex">
      <div
        ...
        ref={reff}
        className="navbar nav-header-main bg-white m-auto mt-5 pb-10 sm:mt-16"
      ...
      >
        <div className="navigation-icons flex justify-end pt-2 pb-2 gap-5">
          ...
          {setting ? (
            <div className="setting-card   bg-white rounded-md p-1 pt-2 pb-5">
              <h4 className="text-lg font-semibold ps-5">Ad Type</h4>
              <div className="flex items-center justify-center p-5 pb-8 z-10">
                <div

...
const isCardActive = (componentName) => {
  ...
  return (
    <div style={{width:headerSize}} ref={reff}   className="navbar nav-header-main bg-white m-auto mt-16" onClick={(e) => e.stopPropagation()}>
      <div className="navigation-icons flex justify-end pt-2 pb-2 gap-5">
        ...
        {setting ? (
          <div className="setting-card drop-shadow-md  bg-white rounded-md p-5">

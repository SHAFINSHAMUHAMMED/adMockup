...
function story({ setHeaderSize, format, adImage, setadImage }) {
  ...
  const mainDivStyle =
    format === "1:1"
      ...
      : {
          background: isPng ? "black" : bgGradient,
          borderRadius: "10px",
        };
    ...
    >
      ...
      <div className="flex justify-between ps-3 pe-3 pt-3 ">
        ...
        <div className="flex gap-2">
          <svg width={20} data-v-46e5644d="" fill="white " viewBox="0 0 20 20">
            <g
              data-v-46e5644d=""
              fill-rule="evenodd"
      ...
      {format == "1:1" ? (
        ...
        >
          ...
          />
          <svg
            className="pen-icon2 me-28 mt-8"
            width={20}
            fill="#ffffff"
            viewBox="0 0 1920 1920"
            xmlns="http://www.w3.org/2000/svg"
      ...
      <h3
        className={`text-white text-lg font-semibold ps-5 ${

  ...
  return (
    <div className="border border-gray-300 bg-gray-200 rounded-md bottom-0">
      ...
      <div className="question-main bg-white w-[95%] p-5 rounded-xl m-auto">
        ...
        <h5
          className="text-center mt-5 text-base input-hover"
          contentEditable={true}
        >
          Company Name
        </h5>
        <h6
          className="text-center mt-3 text-sm input-hover"
          contentEditable={true}
        >
          Thanks you're all set.
        </h6>
        <h5
          className="text-center mt-3 mb-2 text-base input-hover"
          contentEditable={true}
        >
        ...
        <hr />
        <h6
          className="text-center mt-3 text-xs input-hover"
          contentEditable={true}
        >
          You successfully subimtted your responses.
        </h6>
      </div>
      <div className="icons flex justify-evenly pt-3 pb-3 bg-white">
        <button
          className=" bg-blue-500 w-[95%] text-white font-bold m-auto p-2 ps-8 pe-8 rounded-md"
          contentEditable={true}
        >

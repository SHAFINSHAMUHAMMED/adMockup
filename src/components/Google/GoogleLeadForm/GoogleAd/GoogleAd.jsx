...
function GoogleAd({ mobile, setHeaderSize }) {
  ...
  return (
    <div className="bg-white p-5 rounded-lg">
      ...
      <span
        className={` ${mobile ? "text-[12px]" : "text-[14px] input-hover"}`}
      ...
      {!mobile ? (
        <div className="flex items-center gap-1 border w-fit p-1 rounded mt-3">
          ...
          <h4 className={` ${mobile ? "text-[12px]" : "text-[14px]"}`}>
            <span className="input-hover" contentEditable={true}>
              Learn more
            </span>{" "}
            <span>-</span>{" "}
        ...
        <div>
          ...
          <div className="flex items-center gap-2 w-fit p-1 rounded mt-3">
            ...
            <h4 className={`text-[14px] text-gray-500`}>
              ...
              <span className={`${mobile ? "hidden" : ""}`}>-</span> <br />{" "}
              <span className="input-hover" contentEditable={true}>
                Extension text
              </span>
            </h4>

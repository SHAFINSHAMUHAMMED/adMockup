  ...
  return (
    <div className="flex">
      <div
        ...
        ref={reff}
        className="navbar nav-header-main bg-white m-auto mt-10 sm:mt-16"
                  ...
                  <ul>
                    <li className="pb-2 text-gray-600">
                      <label class="relative inline-flex items-center cursor-pointer">
                        <input
                          checked={setlink}
                          onChange={(e) => setsetlink(e.target.checked)}
                          type="checkbox"
                          value=""
                          class="sr-only peer"
                        />
                    ...
                    <li className="pb-2 text-gray-600">
                      <label class="relative inline-flex items-center cursor-pointer">
                        <input
                          checked={snippet}
                          onChange={(e) => setsnippet(e.target.checked)}
                          type="checkbox"
                          value=""
                          class="sr-only peer"
                        />
                    ...
                    <li className="pb-2 text-gray-600">
                      <label class="relative inline-flex items-center cursor-pointer">
                        <input
                          checked={callExt}
                          onChange={(e) => setcallExt(e.target.checked)}
                          type="checkbox"
                          value=""
                          class="sr-only peer"
                        />
